...
```
<g>.chrom.sizes   <g>.2bit   <g>.<N>kb.bins   <g>.blacklist.bed   <g>.gap.bed   <g>.45mer.mappability.bw
```

(`g` = `hg38` or `chm13`). Everything except the mappability bigWig is built live from public sources
...
T2T-CHM13 specifics: the assembly is gap-free, so `chm13.gap.bed` is empty; the blacklist is the
[`excluderanges`](https://dozmorovlab.github.io/excluderanges/) `T2T.excluderanges` set.
